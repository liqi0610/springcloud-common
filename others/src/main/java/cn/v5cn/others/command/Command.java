...
public class Command {
    ...
    public static void main(String[] args) throws InterruptedException, IOException {
        Process process = Command.command("D:\\software\\ffmpeg-20200113-7225479-win64-static\\bin\\ffmpeg.exe -i D:\\users\\Destop\\output\\20200421104857.mp4 -threads 2 -vf scale=1280:-2 -c:v libx264 -preset fast -crf 24 aa.mp4");
        if (process == null) {
