    ...
    public ResponseEntity<OAuth2Exception> translate(Exception e) throws Exception {
        ...
        if(e instanceof HystrixRuntimeException) {
            ...
            if(actual instanceof AbstractException) {
                ...
                code = String.valueOf(((AbstractException) actual).getCode().getCode());
                message = ((AbstractException) actual).getMessage();
                LOGGER.error("AbstractException", actual);
            } else {
                httpStatus = HttpStatus.INTERNAL_SERVER_ERROR.value();
                code = String.valueOf(GenericErrorCodes.GENERIC_API_ERROR_CODE.getCode());
            ...
            oAuth2Exception.addAdditionalInformation("code", StringUtils.isNotEmpty(errorCode) ? errorCode : String.valueOf(GenericErrorCodes.GENERIC_API_ERROR_CODE.getCode()));
